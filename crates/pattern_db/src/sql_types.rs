...
// --- Coordination types ---
impl std::fmt::Display for crate::models::ActivityEventType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::MessageSent => write!(f, "message_sent"),
            Self::ToolUsed => write!(f, "tool_used"),
            Self::MemoryUpdated => write!(f, "memory_updated"),
            Self::TaskChanged => write!(f, "task_changed"),
            Self::AgentStatusChanged => write!(f, "agent_status_changed"),
            Self::ExternalEvent => write!(f, "external_event"),
...
impl std::str::FromStr for crate::models::ActivityEventType {
    type Err = String;

    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "message_sent" => Ok(Self::MessageSent),
            "tool_used" => Ok(Self::ToolUsed),
            "memory_updated" => Ok(Self::MemoryUpdated),
            "task_changed" => Ok(Self::TaskChanged),
            "agent_status_changed" => Ok(Self::AgentStatusChanged),
            "external_event" => Ok(Self::ExternalEvent),
            "coordination" => Ok(Self::Coordination),
            "system" => Ok(Self::System),
            _ => Err(format!("unknown activity event type '{s}'")),
        }
    }
}

impl_text_sql_via_display!(crate::models::ActivityEventType);

impl std::fmt::Display for crate::models::EventImportance {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
...
impl std::str::FromStr for crate::models::EventImportance {
    type Err = String;
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            _ => Err(format!("unknown event importance '{s}'")),
        }
    }
}

impl_text_sql_via_display!(crate::models::EventImportance);

impl std::fmt::Display for crate::models::TaskStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
...
impl std::str::FromStr for crate::models::TaskStatus {
    type Err = String;
...
impl_text_sql_via_display!(crate::models::TaskStatus);

impl std::fmt::Display for crate::models::TaskPriority {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::Low => write!(f, "low"),
            Self::Medium => write!(f, "medium"),
...
impl std::str::FromStr for crate::models::TaskPriority {
    type Err = String;
...
impl_text_sql_via_display!(crate::models::TaskPriority);
...
mod tests {
    ...
    #[test]
    fn coordination_types_round_trip() {
        round_trip(ActivityEventType::ToolUsed, "tool_used");
        round_trip(ActivityEventType::System, "system");
        round_trip(EventImportance::Critical, "critical");
        round_trip(EventImportance::Low, "low");
        round_trip(TaskStatus::InProgress, "in_progress");
        round_trip(TaskStatus::Cancelled, "cancelled");
        round_trip(TaskPriority::Urgent, "urgent");
    }
}
