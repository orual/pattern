-- Pattern v3 Initial Schema (memory.db)
-- One database per constellation - this creates the memory-side schema.
-- Message tables live in messages.db (separate file, attached as `msg`).
